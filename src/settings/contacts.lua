...
function MoonZaphire.SettingsContacts:_class_init(klass)
	...
	klass:bind_template_child_full('btn_new', true, 0)
	klass:bind_template_child_full('search', true, 0)
	klass:bind_template_child_full('list-contacts', true, 0)
...
function MoonZaphire.SettingsContacts:_init()
	...
	local btn_new = self:get_template_child(
		MoonZaphire.SettingsContacts, 'btn_new'
	)
	local btn_back = self:get_template_child(
		MoonZaphire.SettingsContacts, 'btn_back'
	)
	local btn_close = self:get_template_child(
		MoonZaphire.SettingsContacts, 'btn_close'
	)
	...
	btn_back.on_clicked = function ()
		settings_pages:set_visible_child_name('setting_menu')
	end
