--[[--
 @package   MoonZaphire
 @filename  settings/profile.lua
 @version   1.0
 @author    Díaz Urbaneja Víctor Eduardo Diex <victor.vector008@gmail.com>
 @date      07.02.2021 21:24:24 -04
]]

--- I create the SettingsAbout subclass of MoonZaphire
MoonZaphire:class('SettingsProfile', Gtk.Box)

--- At the beginning of the class
function MoonZaphire.SettingsProfile:_class_init(klass)
	--- I load the template
	klass:set_template_from_resource(
		'/com/github/diazvictor/MoonZaphire/data/ui/settings/profile.ui'
	)
...
function MoonZaphire.SettingsProfile:_init()
	-- Start template
	self:init_template()

	-- I load the template objects
	-- local search = self:get_template_child(
		-- MoonZaphire.SettingsProfile, 'btn_close'
	-- )
end
